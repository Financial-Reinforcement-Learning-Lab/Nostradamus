...
if __name__ == "__main__":
    ...
    _ ,df1 = get_datasets(SYMBOL_1, TRADE_INSTRUMENT, HISTO, LIMIT)
    _ ,df2 = get_datasets(SYMBOL_2, TRADE_INSTRUMENT, HISTO, LIMIT)
    _ ,df3 = get_datasets(SYMBOL_3, TRADE_INSTRUMENT, HISTO, LIMIT)
    config = {
        "df1": df1,
        "df2": df2,
        "df3": df3,
    ...
    register_env("MultiTradingEnv-v1", lambda _: TradingEnv(config))
    run(args, parser, df1)